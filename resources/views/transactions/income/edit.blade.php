@extends('layouts.app', ['page' => 'Chỉnh sửa tiền thu vào', 'pageSlug' => 'incomes', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('transactions.type', ['type' => 'income']) }}" class="btn btn-sm btn-primary">Quay lại danh sách</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
