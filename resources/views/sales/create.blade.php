@extends('layouts.app', ['page' => 'Đơn đặt hàng', 'pageSlug' => 'sales-create', 'section' => 'transactions'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Thêm đơn đặt hàng</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.index') }}" class="btn btn-sm btn-primary">Quay lại danh sách</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
